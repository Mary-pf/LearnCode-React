const Description = () => {
    return(
        <section className="bg-dark mx-2 rounded-3">
                    ...
                    <div className="row" style={{paddingRight: "4rem"}}>
                        <div className="col-md-6">
                            <div className="card shadow mb-4">
                                <img src="./Images/9.jpg" className="card-img-top p-2" alt="..." />
                            ...
                            <div className="card">
                                <img src="./Images/10.jpg" className="card-img-top p-2" alt="..." />
                                <div className="card-body">
                                    <h5 className="card-title">Card title</h5>
                                    <p className="card-text">Some quick example text to build on the card title and make
                                        up the bulk of the card's content.</p>
                        ...
                        <div className="col-md-6 mt-5">
                            <div className="card shadow mb-4">
                                <img src="./Images/11.jpg" className="card-img-top p-2" alt="..." />
                                <div className="card-body">
                                    <h5 className="card-title">Card title</h5>
                                    <p className="card-text">Some quick example text to build on the card title and make
                                        up the bulk of the card's content.</p>
                            ...
                            <div className="card">
                                <img src="./Images/12.jpg" className="card-img-top p-2" alt="..." />
                                <div className="card-body">
                                    <h5 className="card-title">Card title</h5>
                                    <p className="card-text">Some quick example text to build on the card title and make
                                        up the bulk of the card's content.</p>
