...
//   return (
//     <>
//       <ul className="nav justify-content-center navbar-light">
...
//             <li className="bg-white rounded-3" style={{ width: "20rem" }}>
//               <div className="grid grid-cols-12 gap-0 ps-4 grid-menu">
...
//                       <span className="text-muted">مسیر پیشرفت آموزشی شما</span>
//                     </div>
//                   </a>
//                 </div>
...
//         </li>
//         <li className="nav-item">
//           <a className="nav-link">لرن کد کست</a>
//         </li>
//         <li className="nav-item">
//           <a className="nav-link">
//             لرن کد نامه<span className="badge bg-danger ms-2">جدید</span>
//           </a>
//         </li>
//         <li className="nav-item dropdown">
//           <a
...
// <Button variant="primary" className="mx-2" onClick={() => navigate('/login')}>ورود</Button>
// <Button variant="outline-primary" onClick={() => navigate('/signUp')}>عضویت</Button>